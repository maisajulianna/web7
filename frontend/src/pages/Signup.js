...
const SignupComponent = ({ setIsAuthenticated }) => {
  ...
  const { signup, error } = useSignup("/api/user/signup");
  ...
  const handler = async (e) => {
    ...
    console.log("User has entered values for registration:",
    " Email: ", emailInput.value,
    " password 1: ", passwordInput.value,
    " password 2: ", password2Input.value,
    " Username: ", usernameInput.value,
    " End of user input.");

    if (!error) {
      console.log("Signup Page passed");
